...
| Service Category | AWS Offering | Azure Corresponding Service |
| :---- | :---- | :---- |
| Hierarchical Structure | AWS Account | Azure Subscription |
| Enterprise Governance | AWS Organizations | Microsoft Entra tenant \+ Management Groups |
| Organizational Units | Tags / accounts / OUs | Resource Groups \+ Tags |
...
| AI & Machine Learning | SageMaker | Azure Machine Learning |
